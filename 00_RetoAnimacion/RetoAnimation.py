...
FrasesS = [ pygame.mixer.Sound('Sonido/Linea1.wav'),
                   pygame.mixer.Sound('Sonido/Linea2.wav'),
                    pygame.mixer.Sound('Sonido/Linea3.wav'),
                    pygame.mixer.Sound('Sonido/Linea4.wav'),]
#Corriendo a 24 Fps lo cual da 1 F cada 0.0417 seg
print(FrasesS[0].get_length()) #0.2587 tarda 12 Frames en sonar
print(FrasesS[1].get_length())
print(FrasesS[2].get_length())
print(FrasesS[3].get_length())
